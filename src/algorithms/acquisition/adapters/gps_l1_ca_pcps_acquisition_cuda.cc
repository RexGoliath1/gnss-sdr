/*!
 * \file gps_l1_ca_pcps_acquisition_cuda.cc
...
GpsL1CaPcpsAcquisitionCuda::GpsL1CaPcpsAcquisitionCuda(
                                ...
                                out_streams_(out_streams)
{
    ...
    acquisition_ = pcps_make_acquisition_cuda(acq_parameters_);
...
void GpsL1CaPcpsAcquisitionCuda::stop_acquisition()
{
    acquisition_->set_active(false);
}


void GpsL1CaPcpsAcquisitionCuda::set_threshold(float threshold)
{
...
void GpsL1CaPcpsAcquisitionCuda::set_doppler_max(unsigned int doppler_max)
{
...
void GpsL1CaPcpsAcquisitionCuda::set_doppler_step(unsigned int doppler_step)
{
...
void GpsL1CaPcpsAcquisitionCuda::set_doppler_center(int doppler_center)
{
...
void GpsL1CaPcpsAcquisitionCuda::set_gnss_synchro(Gnss_Synchro* gnss_synchro)
{
...
signed int GpsL1CaPcpsAcquisitionCuda::mag()
{
    return acquisition_->mag();
}


void GpsL1CaPcpsAcquisitionCuda::init()
{
    acquisition_->init();
}


void GpsL1CaPcpsAcquisitionCuda::set_local_code()
{
...
void GpsL1CaPcpsAcquisitionCuda::reset()
{
    acquisition_->set_active(true);
}


void GpsL1CaPcpsAcquisitionCuda::set_state(int state)
{
    acquisition_->set_state(state);
}


void GpsL1CaPcpsAcquisitionCuda::connect(gr::top_block_sptr top_block)
{
...
void GpsL1CaPcpsAcquisitionCuda::disconnect(gr::top_block_sptr top_block)
{
    if (item_type_ == "gr_complex" || item_type_ == "cshort")
        {
...
gr::basic_block_sptr GpsL1CaPcpsAcquisitionCuda::get_left_block()
{
    if (item_type_ == "gr_complex" || item_type_ == "cshort")
        {
            return acquisition_;
...
gr::basic_block_sptr GpsL1CaPcpsAcquisitionCuda::get_right_block()
{
    return acquisition_;
}


void GpsL1CaPcpsAcquisitionCuda::set_resampler_latency(uint32_t latency_samples)
{
